...
<body>
    ...
    <div id="navbar">
        <ul style="display: flex;">
            ...
            <?php if ($user->isAdministrator == 'y') echo '<a href="adminSite.php" class="bar-item button padding-large white">Admin Area</a>' ?>
            <div style="flex-grow: 0.5;"></div>
    ...
    <div style=" display: block;margin-left: auto;margin-right: auto; margin-top: 2rem;width: max-content;">
        ...
        <table style="width:100%">
            ...
            <tr>
                ...
                <td><?php echo $sInternUser->courseId ?></td>
            </tr>
            <?php
            }
            ?>
